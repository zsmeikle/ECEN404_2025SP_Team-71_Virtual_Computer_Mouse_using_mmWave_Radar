...
class gesture_recognition_model:
    def __init__(self):
        self.gesture_model = keras.models.load_model("C:/Users/snowb/Desktop/Capstone/newest/New_Gesture_CNN2.keras") #Gesture_CNN.keras is GEN 1 | Gesture_CNN5.keras is current GEN
        self.scaler = joblib.load("C:/Users/snowb/Desktop/Capstone/newest/new_gesture_scaler2.bin")      #gesture_scaler2.bin is GEN 1 | gesture_scaler5.bin is current GEN
