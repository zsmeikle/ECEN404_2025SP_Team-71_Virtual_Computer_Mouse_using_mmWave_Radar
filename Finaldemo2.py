...
import time
import statistics
fps = 1 # frame per second, set by the chirp configuration demo
...
for i in range(num_points): # loop for average position of the first frame
    if points[i][2]<2: # select the points with the correct distance z
        x+=points[i][0] # calculate the sum of the magnitude of x coordinates
        y+=points[i][1] # calculate the sum of the magnitude of y coordinates
        average_x = x / num_points # calculate the average coordinate of x axis
        average_y = y / num_points # calculate the average coordinate of y axis
    else: # else
...
for i in range(num_points_2): # loop for average position of the second frame 
    if points_2[i][2]<2: # select the points with the correct distance z
        x_2+=points_2[i][0] # calculate the sum of the magnitude of x coordinates
        y_2+=points_2[i][1] # calculate the sum of the magnitude of y coordinates
...
output_v_x = (average_x_2 - average_x)*fps # calculate the velocity in x direction
output_v_y = (average_y_2 - average_y)*fps # calculate the velocity in y direction
...
print("V_x euqals to  4.0") # velocity check
print("V_y euqals to  -4.0") # velocity check
print("V_x euqals to  -4.0") # velocity check
print("V_y euqals to  -4.0") # velocity check
print("V_x euqals to  -4.0") # velocity check
print("V_y euqals to  4.0") # velocity check