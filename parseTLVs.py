...
def parsePointCloudTLV(tlvData, tlvLength, outputDict):
    ...
    for i in range(numPoints):
        try:
            x, y, z, doppler = struct.unpack(pointStruct, tlvData[:pointStructSize]) #Store radar (X, Y, Z, Doppler) data
        except:
            numPoints = i
...
# Extracted features for 6843 Gesture
...
# def parseGestureProbTLV6843(tlvData, tlvLength, outputDict): #Here
#     probStruct = '10f'
