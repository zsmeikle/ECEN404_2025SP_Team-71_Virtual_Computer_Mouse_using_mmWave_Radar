...
class gesture_recognition_model:
    def __init__(self):
        ...
        self.my_parser.connectComPorts("COM6", "COM5")
        ...
        self.gesture_model = keras.models.load_model("C:/Users/lostk/Documents/A_M/Capstone/Gesture_CNN6.keras") #Gesture_CNN.keras is GEN 1 | Gesture_CNN5.keras is current GEN
        self.scaler = joblib.load("C:/Users/lostk/Documents/A_M/Capstone/gesture_scaler6.bin")      #gesture_scaler2.bin is GEN 1 | gesture_scaler5.bin is current GEN
